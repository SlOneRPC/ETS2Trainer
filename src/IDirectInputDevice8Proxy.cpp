 ...
 *
 ***************************************************************/
#include "IDirectInputDevice8Proxy.h"
#include "Hooking.h"
...
HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::EnumObjects(LPDIENUMDEVICEOBJECTSCALLBACKW p0, LPVOID p1, DWORD p2)
{
...
HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::GetObjectInfo(LPDIDEVICEOBJECTINSTANCEW p0, DWORD p1, DWORD p2)
{
	return m_pDevice->GetObjectInfo(p0, p1, p2);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::GetDeviceInfo(LPDIDEVICEINSTANCEW p0)
{
...
HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::EnumEffects(LPDIENUMEFFECTSCALLBACKW p0, LPVOID p1, DWORD p2)
{
	return m_pDevice->EnumEffects(p0, p1, p2);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::GetEffectInfo(LPDIEFFECTINFOW p0, REFGUID rguid)
{
...
HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::EnumEffectsInFile(LPCWSTR p0, LPDIENUMEFFECTSINFILECALLBACK p1, LPVOID p2, DWORD p3)
{
	return m_pDevice->EnumEffectsInFile(p0, p1, p2, p3);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::WriteEffectToFile(LPCWSTR p0, DWORD p2, LPDIFILEEFFECT p3, DWORD p4)
{
	return m_pDevice->WriteEffectToFile(p0, p2, p3, p4);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::BuildActionMap(LPDIACTIONFORMATW p0, LPCWSTR p1, DWORD p2)
{
	return m_pDevice->BuildActionMap(p0, p1, p2);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::SetActionMap(LPDIACTIONFORMATW p0, LPCWSTR p1, DWORD p2)
{
	return m_pDevice->SetActionMap(p0, p1, p2);
}

HRESULT STDMETHODCALLTYPE IDirectInputDevice8Proxy::GetImageInfo(LPDIDEVICEIMAGEINFOHEADERW p0)
{
